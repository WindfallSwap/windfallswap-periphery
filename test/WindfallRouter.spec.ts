...
import { WindfallFixture } from './shared/fixtures'
...
describe('WindfallRouter', () => {
  ...
  beforeEach(async function() {
    const fixture = await loadFixture(WindfallFixture)
  ...
  it('getAmountOut', async () => {
    ...
    await expect(router.getAmountOut(bigNumberify(0), bigNumberify(100), bigNumberify(100))).to.be.revertedWith(
      'WindfallLibrary: INSUFFICIENT_INPUT_AMOUNT'
    )
  ...
  it('getAmountIn', async () => {
    ...
    await expect(router.getAmountIn(bigNumberify(0), bigNumberify(100), bigNumberify(100))).to.be.revertedWith(
      'WindfallLibrary: INSUFFICIENT_OUTPUT_AMOUNT'
    )
...
describe('fee-on-transfer tokens', () => {
  ...
  beforeEach(async function() {
    ...
    pair = new Contract(pairAddress, JSON.stringify(IWindfallPair.abi), provider).connect(wallet)
  })
